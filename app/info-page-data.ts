...
export const infoPageDefinitions: Record<InfoPageKey, PageDefinition> = {
  ...
  "quote-process": {
    ...
    description:
      "با ابزار آماده‌سازی پیش‌نویس پیش‌فاکتور، اقلام و مبلغ پیشنهادی را بنویسید و برای صدور رسمی با واحد فروش تماس بگیرید.",
    seoDescription:
      "مراحل درخواست پیش‌فاکتور محصولات فولادی و ابزار آماده‌سازی پیش‌نویس غیررسمی پیش‌فاکتور پیش از تماس با واحد فروش.",
    lastmod: "2026-08-25",
  },
  complaints: {

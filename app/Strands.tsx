...
export function Strands({
  ...
  useEffect(() => {
    ...
    try {
      ...
      hasWebGL = Boolean(
        typeof probeCanvas.getContext === "function" &&
          (probeCanvas.getContext("webgl2") ||
            probeCanvas.getContext("webgl") ||
            probeCanvas.getContext("experimental-webgl")),
      );
    } catch {
      // WebGL context acquisition unsupported
    }
    ...
    const initialWidth = ctn.offsetWidth || 300;
    const initialHeight = ctn.offsetHeight || 150;
    ...
    const renderSingleFrame = (t: number) => {
      ...
      if (current.glass && renderTarget && glassProgram && glassMesh) {
